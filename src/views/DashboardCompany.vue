    ...
    <main>
      ...
      <div class="offer-row">
        ...
        <div class="offer-card">
          <a href="offers/offerCompany" style="text-decoration: none; text-align: center">
            <h3>LOGO SOCIÉTÉ</h3>
            <img :src="ImagesLogo" alt="Image de l'offre 1" />
          </a>
        </div>
      ...
      <div class="offer-row">
        <div class="offer-card">
          <a href="offers/offerCompany" style="text-decoration: none; text-align: center">
            <h3>LOGO SOCIÉTÉ</h3>
            <img :src="ImagesLogo" alt="LImage de l'offre 2" />
          </a>
        </div>
        <div class="offer-details">
          <h3>Détails de l'offre</h3>
      ...
      <div class="offer-row">
        <div class="offer-card">
          <a href="offers/offerCompany" style="text-decoration: none; text-align: center">
            <h3>LOGO SOCIÉTÉ</h3>
            <img :src="ImagesLogo" alt="LImage de l'offre 3" />
          </a>
        </div>
        <div class="offer-details">
          <h3>Détails de l'offre</h3>
