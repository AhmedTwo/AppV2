  ...
  <main>
    ...
    <div class="offer-row">
      ...
      <div class="offer-card">
        <a href="offers/offerCompany/1" style="text-decoration: none; text-align: center">
          <h3>LOGO SOCIÉTÉ</h3>
    ...
    <div class="offer-row">
      <div class="offer-card">
        <a href="offers/offerCompany/2" style="text-decoration: none; text-align: center">
          <h3>LOGO SOCIÉTÉ</h3>
          <img :src="ImagesLogo" alt="Offres n°" />
        </a>
        <a href="/accueil/apply" class="apply-btn"> Postuler à l'offre </a>
    ...
    <div class="offer-row">
      <div class="offer-card">
        <a href="offers/offerCompany/3" style="text-decoration: none; text-align: center">
          <h3>LOGO SOCIÉTÉ</h3>
          <img :src="ImagesLogo" alt="Offres n°" />
        </a>
        <a href="/accueil/apply" class="apply-btn"> Postuler à l'offre </a>
    ...
    <div class="offer-row">
      <div class="offer-card">
        <a href="offers/offerCompany/4" style="text-decoration: none; text-align: center">
          <h3>LOGO SOCIÉTÉ</h3>
          <img :src="ImagesLogo" alt="Offres n°" />
        </a>
        <a href="/accueil/apply" class="apply-btn"> Postuler à l'offre </a>
    ...
    <div class="offer-row">
      <div class="offer-card">
        <a href="offers/offerCompany/5" style="text-decoration: none; text-align: center">
          <h3>LOGO SOCIÉTÉ</h3>
          <img :src="ImagesLogo" alt="Offres n°" />
        </a>
        <a href="/accueil/apply" class="apply-btn"> Postuler à l'offre </a>
