...
<template>
  <main>
    ...
    <p class="p">Découvre toutes nos sociétés inscrites à Portal_Job</p>

    <div class="company-grid" id="companyContainer">
      <div class="company-card">
        <a href="offers/offerCompany">
          <img :src="ImagesLogo" alt="Logo entreprise 1" />
        </a>
        <h3>TechNova</h3>
        <p>Informatique</p>
        <div>
          <a href="companys/companyDetails" class="btn-details">Détails</a>
        </div>
      </div>

      <div class="company-card">
        <a href="offers/offerCompany">
          <img :src="ImagesLogo" alt="Logo entreprise 2" />
        </a>
        <h3>GreenWorks</h3>
      ...
      <div class="company-card">
        <a href="offers/offerCompany">
          <img :src="ImagesLogo" alt="Logo entreprise 3" />
        </a>
        <h3>HealthCorp</h3>
        <p>Biotechnologie</p>
        <div>
      ...
      <div class="company-card">
        <a href="offers/offerCompany">
          <img :src="ImagesLogo" alt="Logo entreprise 4" />
        </a>
        <h3>BuildMaster</h3>
        <p>Construction</p>
        <div>
...
<style scoped>
/* Le main reprend une hauteur naturelle */
main {
  flex: 1;
  display: flex;
...
@media (max-width: 480px) {
  ...
  .admin-add-company {
    justify-content: center; /* centre le bouton en mobile */
  }
}
</style>
